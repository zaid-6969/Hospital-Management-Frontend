            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {paginated.map((doc) => {
                  ...
                  const todayEntry = doc.availability?.find(
                  ...
                  return (
                    <div
                      ...
                      style={{ background: "var(--card)", border: `1px solid ${isAvailable ? "rgba(34,197,94,0.25)" : "rgba(239,68,68,0.2)"}` }}
                    >
                      {/* Avatar + name */}
                      <div className="flex items-center gap-3">
                        <div className="relative shrink-0">
                          ...
                          <span
                            ...
                            style={{ background: isAvailable ? "#22c55e" : "#ef4444", borderColor: "var(--card)" }}
                          />
                        </div>
                      ...
                      {/* Today's slots */}
                      {todayEntry?.slots?.length > 0 && (
                        <div className="space-y-1">
                          <p className="text-[10px] font-bold uppercase tracking-widest opacity-40">
                            Today's Slots
                          </p>
                          {todayEntry.slots.map((slot, i) => (
                            <div
                              key={i}
