  ...
  const navLinkStyle = (isActive) =>
    isActive
      ? {
          ...
          boxShadow: "0 4px 14px rgba(106,90,205,.30)",
          color: "white",
        }
      : {};
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg,#6a5acd,#8b5cf6,transparent)",
        }}
      />
        ...
        {!isCollapsed && (
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{
                background: "linear-gradient(135deg,#6a5acd,#8b5cf6)",
                boxShadow: "0 4px 12px rgba(106,90,205,.35)",
              }}
            >
      ...
      <nav className="flex-1 py-4 px-2 flex flex-col gap-0.5 overflow-y-auto">
        ...
        {mainNav.map(({ label, icon: Icon, path }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              navLinkClass(
                path === "/admin" ? location.pathname === "/admin" : isAct
              )
            }
            style={({ isActive }) => {
              const active =
                path === "/admin" ? location.pathname === "/admin" : isActive;
