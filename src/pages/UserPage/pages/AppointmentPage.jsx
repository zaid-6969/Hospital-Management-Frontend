    ...
    return (
      <div className="font-sans bg-gray-50 min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-gray-500 text-base max-w-sm mb-2">
          Your appointment has been booked successfully. A confirmation SMS &
          email has been sent.
        </p>
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mt-6 text-left w-full max-w-sm shadow-lg">
          <div className="flex flex-col gap-3">
            {[
              ...
              <div
                key={r.l}
                className="flex justify-between text-sm border-b border-gray-100 pb-2 last:border-none last:pb-0"
              >
    ...
    <div className="font-sans bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-br from-violet-50 via-white to-purple-50 py-16 px-6 text-center">
        <p className="text-violet-400 text-sm mb-3">
          Home ›{" "}
          <span className="text-violet-600 font-semibold">Appointment</span>
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4">
          Book an Appointment
        </h1>
        <p className="text-gray-500 text-base max-w-xl mx-auto leading-relaxed">
          Schedule a visit with our specialists in just a few clicks. Same-day
          appointments available for most departments.
        </p>
      </div>
          ...
          {[
            ...
            <div key={s.n} className="flex items-center flex-1">
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`text-xs font-bold mt-1.5 hidden sm:block ${step >= s.n ? "text-violet-600" : "text-gray-400"}`}
                >
                  {s.l}
                </span>
              </div>
              {i < 2 && (
                <div
                  className={`flex-1 h-0.5 mx-3 ${step > s.n ? "bg-violet-600" : "bg-gray-200"} transition-all`}
                />
              )}
            </div>
          ))}
      ...
      <section className="py-12 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-xl shadow-violet-50">
            ...
            {step === 1 && (
              <div>
                <span className="inline-block bg-violet-100 text-violet-700 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-3">
                  Step 1 of 3
                </span>
              ...
              <div>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {DOCTORS.map((doc) => (
                        ...
                        >
                          ...
                          <div>
                            <p
                              className={`text-xs font-extrabold ${form.doctor === doc.name ? "text-violet-700" : "text-gray-800"}`}
                            >
                              {doc.name}
                            </p>
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() => setStep(1)}
                      className="flex-1 border-2 border-gray-200 text-gray-600 font-bold py-3 rounded-xl text-sm hover:border-violet-300 transition-all"
                    >
                      ← Back
                    </button>
                    <button
                      onClick={() => form.dept && setStep(3)}
                ...
                <div className="flex flex-col gap-5">
                  ...
                  {form.date && form.time && (
                    <div className="bg-violet-50 border border-violet-200 rounded-2xl p-5">
                      <h4 className="font-extrabold text-violet-700 text-sm mb-3">
                        📋 Appointment Summary
                      </h4>
            ...
            {[
              {
                ...
                d: "Get a confirmed slot immediately without waiting on hold.",
              },
              {
                i: "🕐",
                t: "24/7 Availability",
                d: "Book anytime — day or night, weekday or weekend.",
              },
              {
                i: "🔔",
                t: "Smart Reminders",
                d: "Automated SMS & email reminders before your visit.",
              },
              {
                i: "🔄",
                t: "Easy Rescheduling",
                d: "Change or cancel your appointment with just one click.",
              },
            ].map((b) => (
              <div
                key={b.t}
                className="text-center p-6 bg-gray-50 rounded-2xl hover:bg-violet-50 transition-colors"
              >
                <div className="w-14 h-14 bg-violet-100 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4">
                  {b.i}
                </div>
                <h4 className="font-extrabold text-gray-900 text-sm mb-2">
                  {b.t}
                </h4>
