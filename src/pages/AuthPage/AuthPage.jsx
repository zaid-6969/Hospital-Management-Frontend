    ...
    try {
      if (isLogin) {
        const res = await axios.post(
          "https://hospital-management-backend-ag6n6wmhd.vercel.app/api/v1/auth/login",
          {
        ...
        await axios.post("https://hospital-management-backend-ag6n6wmhd.vercel.app/api/v1/auth/register", {
            ...
            <GoogleLogin
              onSuccess={async (credentialResponse) => {
                try {
                  ...
                  const res = await axios.post(
                    "https://hospital-management-backend-ag6n6wmhd.vercel.app/api/v1/auth/google",
                    { token },
                    { withCredentials: true },
                  );
