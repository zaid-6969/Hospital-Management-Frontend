    ...
    try {
      if (isLogin) {
        const res = await axios.post(
          "https://hospital-management-backend-bg8yivi7s.vercel.app/api/v1/auth/login",
          {
        ...
        await axios.post("https://hospital-management-backend-bg8yivi7s.vercel.app/api/v1/auth/register", {
            ...
            <GoogleLogin
              onSuccess={async (credentialResponse) => {
                try {
                  ...
                  const res = await axios.post(
                    "https://hospital-management-backend-bg8yivi7s.vercel.app/api/v1/auth/google",
                    { token },
                    { withCredentials: true },
                  );
